...
public class Activity1 {
	...
	//Declaring the required drivers
		...
		public void addNum()
		{
			...
			driver.findElement(AppiumBy.accessibilityId("plus"));
			//Find the path to number and tap it
		...
		{
			//Find the path to number and tap it
			driver.findElement(AppiumBy.id("digit_6"));
			//Find the path to multiply and tap it
			driver.findElement(AppiumBy.accessibilityId("minus"));
			//Find the path to number and tap it
			driver.findElement(By.id("digit_5"));
			//Find the path to equals to and tap it
			driver.findElement(AppiumBy.accessibilityId("equals"));
		...
		public void divideNum()
		{
			...
			driver.findElement(AppiumBy.id("digit_6"));
			//Find the path to multiply and tap it
			driver.findElement(AppiumBy.accessibilityId("divide"));
			//Find the path to number and tap it
			driver.findElement(By.id("digit_3"));
			//Find the path to equals to and tap it
			driver.findElement(AppiumBy.accessibilityId("equals"));
			//find and assert the result
			String result = driver.findElement(AppiumBy.id("result_final")).getText();
